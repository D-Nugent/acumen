		...
		<section className="about">
			<div className="about__container">
				...
				<p className="about__text">
					...
					either pre-prepared or in a real-time environment. Prospective employers can
				...
				<p className="about__text about__emph">
					Let's start making recruitment inclusive and invest in people again.
				</p>
			</div>
		</section>
	)
